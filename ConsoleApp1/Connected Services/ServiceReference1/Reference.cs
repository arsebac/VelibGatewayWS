...
namespace ConsoleApp1.ServiceReference1 {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceReference1.IVelibService", CallbackContract=typeof(ConsoleApp1.ServiceReference1.IVelibServiceCallback))]
    public interface IVelibService {
        ...
        ConsoleApp1.ServiceReference1.Contract[] GetContractsList(bool useCache);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IVelibService/GetContractsList", ReplyAction="http://tempuri.org/IVelibService/GetContractsListResponse")]
        System.Threading.Tasks.Task<ConsoleApp1.ServiceReference1.Contract[]> GetContractsListAsync(bool useCache);
        ...
        ConsoleApp1.ServiceReference1.Station[] GetStationsByContract(ConsoleApp1.ServiceReference1.Contract contract, bool useCache);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IVelibService/GetStationsByContract", ReplyAction="http://tempuri.org/IVelibService/GetStationsByContractResponse")]
        System.Threading.Tasks.Task<ConsoleApp1.ServiceReference1.Station[]> GetStationsByContractAsync(ConsoleApp1.ServiceReference1.Contract contract, bool useCache);
        ...
        ConsoleApp1.ServiceReference1.Contract[] SearchContract(string contract, bool useCache);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IVelibService/SearchContract", ReplyAction="http://tempuri.org/IVelibService/SearchContractResponse")]
        System.Threading.Tasks.Task<ConsoleApp1.ServiceReference1.Contract[]> SearchContractAsync(string contract, bool useCache);
        ...
        void SubscribeStationEvent(ConsoleApp1.ServiceReference1.Contract contract, ConsoleApp1.ServiceReference1.Station station, int T);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IVelibService/SubscribeStationEvent", ReplyAction="http://tempuri.org/IVelibService/SubscribeStationEventResponse")]
        System.Threading.Tasks.Task SubscribeStationEventAsync(ConsoleApp1.ServiceReference1.Contract contract, ConsoleApp1.ServiceReference1.Station station, int T);
    }
    ...
    public interface IVelibServiceCallback {
        ...
        void CallBackContract(ConsoleApp1.ServiceReference1.Contract contract);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IVelibService/CallBackStations")]
        void CallBackStations(ConsoleApp1.ServiceReference1.Station stations);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IVelibServiceChannel : ConsoleApp1.ServiceReference1.IVelibService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class VelibServiceClient : System.ServiceModel.DuplexClientBase<ConsoleApp1.ServiceReference1.IVelibService>, ConsoleApp1.ServiceReference1.IVelibService {
        ...
        public ConsoleApp1.ServiceReference1.Contract[] GetContractsList(bool useCache) {
            return base.Channel.GetContractsList(useCache);
        }
        
        public System.Threading.Tasks.Task<ConsoleApp1.ServiceReference1.Contract[]> GetContractsListAsync(bool useCache) {
            return base.Channel.GetContractsListAsync(useCache);
        }
        
        public ConsoleApp1.ServiceReference1.Station[] GetStationsByContract(ConsoleApp1.ServiceReference1.Contract contract, bool useCache) {
            return base.Channel.GetStationsByContract(contract, useCache);
        }
        
        public System.Threading.Tasks.Task<ConsoleApp1.ServiceReference1.Station[]> GetStationsByContractAsync(ConsoleApp1.ServiceReference1.Contract contract, bool useCache) {
            return base.Channel.GetStationsByContractAsync(contract, useCache);
        }
        
        public ConsoleApp1.ServiceReference1.Contract[] SearchContract(string contract, bool useCache) {
            return base.Channel.SearchContract(contract, useCache);
        }
        
        public System.Threading.Tasks.Task<ConsoleApp1.ServiceReference1.Contract[]> SearchContractAsync(string contract, bool useCache) {
        ...
        public void SubscribeStationEvent(ConsoleApp1.ServiceReference1.Contract contract, ConsoleApp1.ServiceReference1.Station station, int T) {
            base.Channel.SubscribeStationEvent(contract, station, T);
        }
        
        public System.Threading.Tasks.Task SubscribeStationEventAsync(ConsoleApp1.ServiceReference1.Contract contract, ConsoleApp1.ServiceReference1.Station station, int T) {
